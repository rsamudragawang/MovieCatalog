package com.ganargatul.moviecatalogue.viewmodel;
...
public class MovieViewModel extends AndroidViewModel {
    ...
    public MovieViewModel(@NonNull Application application) {
        ...
        searchurl = application.getResources().getString(R.string.api_movie_search);
    ...
    public void searchMovie(String title){
        String URL_SEARCH = searchurl + title;
