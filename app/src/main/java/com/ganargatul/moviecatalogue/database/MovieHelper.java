...
//        cursor.close();
    ...
    public Cursor queryByIdProvider(String id){
        return database.query(DATABASE_TABLE,null,DatabaseContract.MovieColoumn._ID,new String[]{id},null,null,null);
    }
    ...
    public int updateProvider(String id,ContentValues values){
        return database.update(DATABASE_TABLE,values,DatabaseContract.MovieColoumn._ID + " = ?",new String[]{id});
    }
    public int deleteProvider(String id){
        return database.delete(DATABASE_TABLE,DatabaseContract.MovieColoumn._ID+ " = ?",new String[]{id});
    }
}
