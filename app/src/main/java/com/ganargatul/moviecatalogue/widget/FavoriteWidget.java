...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.ganargatul.moviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.ganargatul.moviecatalogue.EXTRA_ITEM";
