package com.ganargatul.moviecatalogue.adapter;
...
public class MovieTvAdapter extends RecyclerView.Adapter<MovieTvAdapter.MovieTvViewHolder>  {
    ...
    public void updateMovieTvItems(ArrayList<MovieTvItems> movieTvItems){
        mMovieTvItems = movieTvItems;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NonNull MovieTvViewHolder holder, int position) {
        ...
        holder.mTextView.setText(movieTvItems.getTitle());
        Picasso.with(mContext).load("https://image.tmdb.org/t/p/w500"+movieTvItems.getPhoto()).into(holder.mCircleImageView);
    ...
    public class MovieTvViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieTvViewHolder(@NonNull View itemView) {
            ...
            mTextView = itemView.findViewById(R.id.title_items);
